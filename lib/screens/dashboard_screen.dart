          ...
          child: Column(
            children: [
              if (aiService.currentAnalysis != null)
                ...
                Expanded(child: sortedTasks.isEmpty ? const Center(child: Text('No tasks added yet'))
                  : ListView.builder(
                ...
                ElevatedButton(
                  ...
                  child: aiService.isLoading ? const CircularProgressIndicator() : const Text('Resolve Conflict With AI'),
                ),
            ],
        ),
        ),
